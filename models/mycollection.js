...
const booklistStore = {
  store: new JsonStore("./models/mycollection.json", {
    bookListsCollection: [],
  }),
  ...
  editBooklist(booklistId, updatedBooklist) {
    this.store.editItem(this.collection, booklistId, this.array, updatedBooklist);
},
};
